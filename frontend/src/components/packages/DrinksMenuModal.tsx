...
export const DrinksMenuModal: React.FC<DrinksMenuModalProps> = ({ isOpen, onClose }) => {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6">
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="absolute inset-0 bg-[#2C3E2E]/80 backdrop-blur-sm"
          />
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh] z-10"
          >
            {/* Header */}
            <div className="flex justify-between items-center px-5 py-4 border-b border-gray-100 shrink-0">
              ...
              <button 
                onClick={onClose}
                className="p-2.5 bg-gray-100 hover:bg-gray-200 active:scale-95 rounded-full transition-all text-gray-600"
                aria-label="Zatvori"
              >
                <X className="w-5 h-5" />
              </button>
            ...
            <div className="relative flex-1 overflow-hidden bg-gray-50 flex items-center justify-center p-2 sm:p-4 touch-pan-y">
              <AnimatePresence mode="wait">
                <motion.img 
                  ...
                  className="max-w-full h-auto max-h-[68vh] object-contain rounded-lg shadow-sm cursor-grab active:cursor-grabbing select-none"
                />
              </AnimatePresence>
