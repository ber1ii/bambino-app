          ...
          >
            ...
            <div className="space-y-6 sm:space-y-8 relative z-10">
              <div className="flex items-start gap-3.5 sm:gap-5">
                ...
                <div>
                  <h4 className="font-black text-base sm:text-lg text-[#2C3E2E] mb-0.5 sm:mb-1">
                    Naša Lokacija
                  </h4>
                  <p className="text-[#2C3E2E]/70 font-bold text-sm sm:text-base leading-relaxed">
                    Veselina Masleše 32a
                    <br />
              ...
              <div className="flex items-start gap-3.5 sm:gap-5">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-[#2C3E2E]/70 font-bold text-sm sm:text-base hover:text-[#4CAF50] transition-colors"
                  >
                    +381 64 2745930
                  </a>
                </div>
              ...
              <div className="flex items-start gap-3.5 sm:gap-5">
                <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-[#E1306C]/10 text-[#E1306C] flex items-center justify-center shrink-0 border border-[#E1306C]/20">
                ...
                <div>
                  ...
                  <a
                    href="https://www.instagram.com/bambino_igraonica_ns/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#2C3E2E]/70 font-bold text-sm sm:text-base hover:text-[#E1306C] transition-colors"
                  >
                    @bambino_igraonica_ns
                  </a>
                </div>
              </div>
